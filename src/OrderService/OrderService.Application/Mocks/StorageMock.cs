...
public interface IStorageServiceMock
{
    ...
    Task<DateTime> GetDeliveryDate(Guid pvzId, IEnumerable<Guid> productId);
...
public class StorageServiceMock : IStorageServiceMock
{
    ...
    public Task<DateTime> GetDeliveryDate(Guid pvzId, IEnumerable<Guid> productId) => Task.FromResult(DateTime.Now);
