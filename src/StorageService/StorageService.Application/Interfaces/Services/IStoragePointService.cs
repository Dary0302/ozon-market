...
{
    Task<Result<Guid>> AddStoragePoint(StoragePoint storagePoint, CancellationToken cancellationToken);
    
    Task<Result<StoragePoint>> GetStoragePoint(Guid id, CancellationToken cancellationToken);
    
    Task<Result> UpdateStoragePoint(Guid id, StoragePoint storagePoint, CancellationToken cancellationToken);
